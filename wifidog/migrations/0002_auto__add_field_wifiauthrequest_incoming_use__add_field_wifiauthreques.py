...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WIFIAuthRequest.incoming_use'
        db.add_column('wifidog_wifiauthrequest', 'incoming_use',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WIFIAuthRequest.outgoing_use'
        db.add_column('wifidog_wifiauthrequest', 'outgoing_use',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WIFIAuthRequest.incoming_use'
        db.delete_column('wifidog_wifiauthrequest', 'incoming_use')

        # Deleting field 'WIFIAuthRequest.outgoing_use'
        db.delete_column('wifidog_wifiauthrequest', 'outgoing_use')
    ...
    models = {
        ...
        'wifidog.wifiauthrequest': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'incoming': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'incoming_use': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'ip': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'mac': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'outgoing': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'outgoing_use': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
