...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('wifiauth_tokens')

        # Adding model 'Token'
        db.create_table('wifiauth_token', (
            ('token', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='tokens', unique=True, to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('wifiauth', ['Token'])


    def backwards(self, orm):
        # Adding model 'Tokens'
        db.create_table('wifiauth_tokens', (
            ('token', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='tokens', unique=True, to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('wifiauth', ['Tokens'])

        # Deleting model 'Token'
        db.delete_table('wifiauth_token')
    ...
    models = {
        ...
        'wifiauth.token': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'tokens'", 'unique': 'True', 'to': "orm['auth.User']"})
        },
