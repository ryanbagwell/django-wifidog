...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #db.delete_unique('wifiauth_token', ['token'])


        # Changing field 'Token.token'
        db.alter_column('wifiauth_token', 'token', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Token.user'
        db.alter_column('wifiauth_token', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, primary_key=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Token.token'
        db.alter_column('wifiauth_token', 'token', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True))
        # Adding unique constraint on 'Token', fields ['token']
        db.create_unique('wifiauth_token', ['token'])


        # Changing field 'Token.user'
        db.alter_column('wifiauth_token', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
    ...
    models = {
        ...
        'wifiauth.token': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'tokens'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['auth.User']"})
        },
