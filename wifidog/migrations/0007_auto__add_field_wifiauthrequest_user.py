...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WIFIAuthRequest.user'
        db.add_column('wifiauth_wifiauthrequest', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='auth_requests', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WIFIAuthRequest.user'
        db.delete_column('wifiauth_wifiauthrequest', 'user_id')
